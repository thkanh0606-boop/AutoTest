...
def pcm_suite_cases() -> list[dict]:
    ...
    return [
        ...
        _case(18, "plt_fleet", "Xe", "Kiểm tra bảng danh sách xe hiển thị đủ cột", "Bảng có Ảnh xe, Xe, Thông số, Trạng thái, Mã booking, Thao tác", "fleet_table_headers"),
        ...
        _case(21, "plt_fleet", "Xe", "Sửa thông tin xe", "Form sửa có trường đời xe, màu và nhiên liệu", "fleet_edit_form"),
