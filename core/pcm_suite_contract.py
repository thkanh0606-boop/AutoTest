...
def pcm_suite_cases() -> list[dict]:
    ...
    return [
        ...
        _case(7, "plt_dashboard", "Dashboard", "Kiểm tra tiêu đề trang Tổng quan", "Tiêu đề Tổng quan hiển thị", "dashboard_title"),
        ...
        _case(10, "plt_dashboard", "Dashboard", "Bấm nút Tạo đơn thuê trên Dashboard", "Điều hướng đến trang tạo đơn thuê", "dashboard_create_booking"),
